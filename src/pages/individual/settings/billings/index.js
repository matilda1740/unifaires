...
import BillingsSection from 'components/DashboardIndividual/Pages/Settings/Billings';
...
const Main = () => {
  return (
    <ThemeProvider theme={theme}>
      <Fragment>
        <Head>
          <title>Unifaires | Billings </title>
        ...
        <AppWrapper>
          ...
          <IndividualWrapper content={(<SettingsSection content={(<BillingsSection />)} />)}/>       
          </AppWrapper>
      </Fragment>
    </ThemeProvider>
  );
