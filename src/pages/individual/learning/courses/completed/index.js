...
import CourseCompleted from 'components/DashboardIndividual/Pages/Learning/CourseCompleted';
...
const Main = () => {
  return (
    <ThemeProvider theme={theme}>
      <Fragment>
        <Head>
          <title>Unifaires Course Completed</title>
        ...
        <AppWrapper>
          ...
          <IndividualWrapper content={(<CourseCompleted />)} />
        </AppWrapper>
      </Fragment>
    </ThemeProvider>
  );
