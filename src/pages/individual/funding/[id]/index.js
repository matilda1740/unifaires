...
import SpecificFundingSection from 'components/DashboardIndividual/Pages/Funding/SpecificFunding';
...
const Main = () => {
  return (
    <ThemeProvider theme={theme}>
      <Fragment>
        <Head>
          <title>Unifaires | Individual | Specific Funding</title>
        ...
        <AppWrapper>
          ...
          <UserWrapper 
            content={(<LearningSection content={(<SpecificFundingSection />)} />)}
          />
        </AppWrapper>
      </Fragment>
    </ThemeProvider>
