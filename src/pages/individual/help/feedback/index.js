...
import HelpFeedback from 'components/DashboardIndividual/Pages/Help/Feedback';
...
const Main = () => {
  return (
    <ThemeProvider theme={theme}>
      <Fragment>
        <Head>
          <title>Unifaires | Feedback </title>
        ...
        <AppWrapper>
          ...
          <IndividualWrapper content={(<HelpSectionWrapper content={(<HelpFeedback/>)}/>)}/>           
          </AppWrapper>
      </Fragment>
    </ThemeProvider>
  );
