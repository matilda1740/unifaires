...
import InstructorsSection from 'components/DashboardBusiness/Pages/Home/AccountManagement/AccountsContent/instructors';
...
const Main = () => {
  return (
    <ThemeProvider theme={theme}>
      <Fragment>
        <Head>
          <title>Unifaires | Instructors</title>
        ...
        <AppWrapper>
          ...
          <BusinessWrapper content={<AccountsManagement content={<InstructorsSection />} />}/>    
        </AppWrapper>
      </Fragment>
    </ThemeProvider>
  );
