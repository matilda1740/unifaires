...
import SectionWrapper, { ModuleColumn, ModuleHeading, HeadingLeft, HeadingRight,ToggleButton, OptionsRow,OptionButton, ModuleSection, SectionHeading,  ModuleRow, ModuleRowEmpty, CoursesCard, JobCard, DashboardBadge, SearchBar } from '../DashboardBusiness/business.style';
                    ...
                    <ModuleRow>
                        {
                            section.courses.map(( course => (
                                <CoursesCard>
                                    ...
                                    <button className="course_card_button">Start Course</button>
                                </CoursesCard>
                            )))
                        }
